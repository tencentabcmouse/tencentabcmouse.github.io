...
(function () {
    ...
    (function () {
        ...
        for (var i = 0; i < length; ++i) {
            var src_ = images[i].getAttribute('src');
    ...
    (function () {
        var imageLink = document.querySelectorAll('.weapp_image_link');
        ...
        for (var i = 0; i < length; ++i) {
            imageLink[i].addEventListener('click', onImageLinkClick);
        }
    })();
    ...
    (function () {
        if (window.__zoom != 1) {
            ...
            for (var i = 0, il = iframe.length; i < il; i++) {
                ...
                a.setAttribute("src", "https://v.qq.com/iframe/player.html?vid=" + vid + "&width=" + vw + "&height=" + vh + "&auto=0");
